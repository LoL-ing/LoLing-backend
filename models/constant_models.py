...
class Champions(BaseIdModel):
    ...
    name_en = Column(String(20), nullable=False, unique=True,
                     comment='champion의 영어 이름이다.')
    name_kr = Column(String(15), nullable=False, unique=True,
                     comment='champion 의 한글 이름이다. (API 요청 시 영어 이름이 오기에 필요)')
    image_url = Column(String(2083), nullable=True,
                       comment='champion 에 해당하는 image 의 url 값이다.')
...
class Lines(BaseIdModel):
    ...
    name = Column(String(10), nullable=False,
                  unique=True, comment='line 의 이름이다.')
    image_url = Column(String(2083), nullable=True,
                       comment='line 에 해당하는 image 의 url 값이다.')
...
class Profile_icons(BaseIdModel):
    ...
    __table_args__ = {"schema": "CONSTANT"}
    image_url = Column(String(2083), nullable=True,
                       comment='profile_icon 에 해당하는 image 의 url 값이다.')
...
class Runes(BaseIdModel):
    ...
    name = Column(String(20), nullable=False,
                  unique=True, comment='rune 의 이름이다.')
    image_url = Column(String(2083), nullable=True,
                       comment='rune 에 해당하는 image 의 url 값이다.')
...
class Schools(BaseIdModel):
    ...
    school_type = Column(String(
        1), nullable=True, comment='초등학교, 중학교, 고등학교, 대학교를 구분한 요소이다. 학교별 구분을 용이하게 하는 목적으로 사용한다.')
...
class Tiers(BaseIdModel):
    ...
    __table_args__ = {"schema": "CONSTANT"}
    name = Column(String(20), nullable=False,
                  unique=True, comment='tier 의 이름이다.')
    image_url = Column(String(2083), nullable=True,
                       comment='tier 에 해당하는 image 의 url 값이다.')
...
class Spells(BaseIdModel):
    ...
    __table_args__ = {"schema": "CONSTANT"}
    name = Column(String(20), nullable=False,
                  unique=True, comment='spell의 공식 명칭이다.')
    image_url = Column(String(2083), nullable=True,
                       comment='profile icon 에 해당하는 image 의 url 값이다.')
